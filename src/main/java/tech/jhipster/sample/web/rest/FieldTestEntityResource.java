...
public class FieldTestEntityResource {
    ...
    public Mono<ResponseEntity<FieldTestEntity>> updateFieldTestEntity(@Valid @RequestBody FieldTestEntity fieldTestEntity)
        throws URISyntaxException {
    ...
    public Mono<ResponseEntity<FieldTestEntity>> partialUpdateFieldTestEntity(@NotNull @RequestBody FieldTestEntity fieldTestEntity)
        throws URISyntaxException {
