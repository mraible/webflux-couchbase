...
public class EntityWithDTOResource {
    ...
    public Mono<ResponseEntity<EntityWithDTODTO>> updateEntityWithDTO(@RequestBody EntityWithDTODTO entityWithDTODTO)
        throws URISyntaxException {
    ...
    public Mono<ResponseEntity<EntityWithDTODTO>> partialUpdateEntityWithDTO(@RequestBody EntityWithDTODTO entityWithDTODTO)
        throws URISyntaxException {
