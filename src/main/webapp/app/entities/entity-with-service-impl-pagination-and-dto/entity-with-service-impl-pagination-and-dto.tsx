...
export const EntityWithServiceImplPaginationAndDTO = (props: IEntityWithServiceImplPaginationAndDTOProps) => {
  ...
  const { entityWithServiceImplPaginationAndDTOList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="entity-with-service-impl-pagination-and-dto-heading" data-cy="EntityWithServiceImplPaginationAndDTOHeading">
        <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplPaginationAndDTO.home.title">
          Entity With Service Impl Pagination And DTOS
        </Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplPaginationAndDTO.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplPaginationAndDTO.home.createLabel">
        ...
        {entityWithServiceImplPaginationAndDTOList && entityWithServiceImplPaginationAndDTOList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('theo')}>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplPaginationAndDTO.id}`}
                        color="info"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplPaginationAndDTO.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplPaginationAndDTO.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplPaginationAndDTO.home.notFound">
...
const mapStateToProps = ({ entityWithServiceImplPaginationAndDTO }: IRootState) => ({
  ...
  loading: entityWithServiceImplPaginationAndDTO.loading,
...
export default connect(mapStateToProps, mapDispatchToProps)(EntityWithServiceImplPaginationAndDTO);
