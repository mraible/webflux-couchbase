...
export const EntityWithServiceClassAndPagination = (props: IEntityWithServiceClassAndPaginationProps) => {
  ...
  const { entityWithServiceClassAndPaginationList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="entity-with-service-class-and-pagination-heading" data-cy="EntityWithServiceClassAndPaginationHeading">
        <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceClassAndPagination.home.title">
          Entity With Service Class And Paginations
        </Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceClassAndPagination.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceClassAndPagination.home.createLabel">
        ...
        {entityWithServiceClassAndPaginationList && entityWithServiceClassAndPaginationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('enzo')}>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceClassAndPagination.id}`}
                        color="info"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceClassAndPagination.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceClassAndPagination.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceClassAndPagination.home.notFound">
...
const mapStateToProps = ({ entityWithServiceClassAndPagination }: IRootState) => ({
  ...
  loading: entityWithServiceClassAndPagination.loading,
...
export default connect(mapStateToProps, mapDispatchToProps)(EntityWithServiceClassAndPagination);
