...
export const EntityWithServiceImplAndPagination = (props: IEntityWithServiceImplAndPaginationProps) => {
  ...
  const { entityWithServiceImplAndPaginationList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="entity-with-service-impl-and-pagination-heading" data-cy="EntityWithServiceImplAndPaginationHeading">
        <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplAndPagination.home.title">
          Entity With Service Impl And Paginations
        </Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplAndPagination.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplAndPagination.home.createLabel">
        ...
        {entityWithServiceImplAndPaginationList && entityWithServiceImplAndPaginationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('hugo')}>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplAndPagination.id}`}
                        color="info"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplAndPagination.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${entityWithServiceImplAndPagination.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sampleCouchbaseNoCacheApp.entityWithServiceImplAndPagination.home.notFound">
...
const mapStateToProps = ({ entityWithServiceImplAndPagination }: IRootState) => ({
  ...
  loading: entityWithServiceImplAndPagination.loading,
...
export default connect(mapStateToProps, mapDispatchToProps)(EntityWithServiceImplAndPagination);
