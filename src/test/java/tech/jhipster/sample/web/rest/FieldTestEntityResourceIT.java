...
class FieldTestEntityResourceIT {
    ...
    void getAllFieldTestEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-entities?sort=id,desc")
    ...
    void getFieldTestEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-entities/{id}", fieldTestEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
