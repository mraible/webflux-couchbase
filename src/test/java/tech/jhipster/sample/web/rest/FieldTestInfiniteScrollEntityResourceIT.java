...
class FieldTestInfiniteScrollEntityResourceIT {
    ...
    void createFieldTestInfiniteScrollEntity() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/field-test-infinite-scroll-entities")
    ...
    void getAllFieldTestInfiniteScrollEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-infinite-scroll-entities?sort=id,desc")
    ...
    void getFieldTestInfiniteScrollEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-infinite-scroll-entities/{id}", fieldTestInfiniteScrollEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestInfiniteScrollEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-infinite-scroll-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
