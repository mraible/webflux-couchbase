...
class DocumentBankAccountResourceIT {
    ...
    void createDocumentBankAccount() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/document-bank-accounts")
    ...
    void getAllDocumentBankAccounts() {
        ...
        webTestClient
            .get()
            .uri("/api/document-bank-accounts?sort=id,desc")
    ...
    void getDocumentBankAccount() {
        ...
        webTestClient
            .get()
            .uri("/api/document-bank-accounts/{id}", documentBankAccount.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingDocumentBankAccount() {
        ...
        webTestClient
            .get()
            .uri("/api/document-bank-accounts/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
