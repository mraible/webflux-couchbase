...
class FieldTestMapstructAndServiceClassEntityResourceIT {
    ...
    void createFieldTestMapstructAndServiceClassEntity() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/field-test-mapstruct-and-service-class-entities")
    ...
    void getAllFieldTestMapstructAndServiceClassEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-mapstruct-and-service-class-entities?sort=id,desc")
    ...
    void getFieldTestMapstructAndServiceClassEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-mapstruct-and-service-class-entities/{id}", fieldTestMapstructAndServiceClassEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestMapstructAndServiceClassEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-mapstruct-and-service-class-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
