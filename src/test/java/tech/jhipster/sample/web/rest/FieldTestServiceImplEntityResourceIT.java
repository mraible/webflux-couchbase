...
class FieldTestServiceImplEntityResourceIT {
    ...
    void createFieldTestServiceImplEntity() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/field-test-service-impl-entities")
    ...
    void getAllFieldTestServiceImplEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-impl-entities?sort=id,desc")
    ...
    void getFieldTestServiceImplEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-impl-entities/{id}", fieldTestServiceImplEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestServiceImplEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-impl-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
