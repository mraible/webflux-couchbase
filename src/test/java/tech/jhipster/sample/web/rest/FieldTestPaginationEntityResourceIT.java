...
class FieldTestPaginationEntityResourceIT {
    ...
    void createFieldTestPaginationEntity() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/field-test-pagination-entities")
    ...
    void getAllFieldTestPaginationEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-pagination-entities?sort=id,desc")
    ...
    void getFieldTestPaginationEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-pagination-entities/{id}", fieldTestPaginationEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestPaginationEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-pagination-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
