...
class FieldTestServiceClassAndJpaFilteringEntityResourceIT {
    ...
    void createFieldTestServiceClassAndJpaFilteringEntity() throws Exception {
        ...
        webTestClient
            .post()
            .uri("/api/field-test-service-class-and-jpa-filtering-entities")
    ...
    void getAllFieldTestServiceClassAndJpaFilteringEntities() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-class-and-jpa-filtering-entities?sort=id,desc")
    ...
    void getFieldTestServiceClassAndJpaFilteringEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-class-and-jpa-filtering-entities/{id}", fieldTestServiceClassAndJpaFilteringEntity.getId())
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isOk()
    ...
    void getNonExistingFieldTestServiceClassAndJpaFilteringEntity() {
        ...
        webTestClient
            .get()
            .uri("/api/field-test-service-class-and-jpa-filtering-entities/{id}", Long.MAX_VALUE)
            .accept(MediaType.APPLICATION_JSON)
            .exchange()
            .expectStatus()
            .isNotFound();
